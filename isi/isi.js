...
function Scroller(props){
	...
	    if(macosPlatforms.indexOf(platform) !== -1) {
			...
			}else if(userAgent.includes('firefox') && !userAgent.includes('chrome')){
	...
	    }else if(windowsPlatforms.indexOf(platform) !== -1) {
			...
			switch(true){
				case userAgent.indexOf('trident') > 0:
					document.querySelector('#isi').classList.add('ie-11')
				break;
				case userAgent.includes('edge'):
					document.querySelector('#isi').classList.add('ie-edge')
					//alert('in edge')
				break;
				...
				case userAgent.includes('firefox'):
					document.querySelector('#isi').classList.add('ff-pc')
					//alert('in ff')
				break;
				default:
				break;
